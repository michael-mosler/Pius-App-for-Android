...
public class GeneralPreferencesFragment extends Fragment implements HttpResponseCallback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.content_preferences_general, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mGradePicker.setOnValueChangedListener((picker, oldVal, newVal) -> gradePickerDidSelectRow(newVal));
        mClassPicker.setOnValueChangedListener((picker, oldVal, newVal) -> classPickerDidSelect(newVal));
        ...
        mCoursesButton.setOnClickListener((v) -> {
            FragmentTransaction t = requireActivity().getSupportFragmentManager().beginTransaction();
            t.replace(R.id.contentPreferencesGeneral, new CourseListFragment());
    ...
    public void execute(HttpResponseData data) {
        try {
            ...
            if (data.getHttpStatusCode() == 200) {
                ...
                mSuccessCheckMark.postDelayed(() -> mSuccessCheckMark.setVisibility(View.GONE), 2000);
            } else {
                AppDefaults.setAuthenticated(false);
                updateLoginButtonText(false);
            }
