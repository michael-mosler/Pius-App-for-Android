...
public class ContentGeneralPreferencesFragment extends Fragment implements HttpResponseCallback {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mCoursesButton.setOnClickListener((v) -> parent.navigateTo(new ContentCourseListFragment()));
    }
